...
export const UsuarioController = {
  ...
  async update(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json('Nao foi possivel atualizar os dados do Usuario!');
    }
  },
  ...
  async getAll(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json('Algo deu errado ao tentar listar os Usuarios!');
    }
  },
  ...
  async getOne(req: Request, res: Response) {
    try {
      ...
      return res
        .status(500)
        .json('Algo errado aconteceu ao tentar listar este Usuario!');
    }
  },
};
