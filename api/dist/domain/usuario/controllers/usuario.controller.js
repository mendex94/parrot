...
exports.UsuarioController = {
    createUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { name, email, password, apartment, photo } = req.body;
                if (!name || !email || !password || !apartment || !photo)
    ...
    updateUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const { name, username, avatar, email, apartment, password, admin } = req.body;
                ...
                const updatedUser = yield Users.update({
